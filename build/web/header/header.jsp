<header class="header">
                ...
                <div class="col-sm-8 d-none d-sm-block">
                    <ul class="list-inline mb-0">
                        <li class="list-inline-item pr-3 mr-0">
                            <a href="/carrito-web"  class="text-gray-900" target="_blank">
    ...
    <nav class="navbar navbar-expand-lg bg-transparent navbar-light navbar-airy bg-fixed-white">
        <div class="container-fluid">
            <a class="navbar-brand" href="/carrito-web">
                <img src="/carrito-web/assets/img/logo.svg" width="180">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item dropdown">
                        <a class="nav-link active" id="homeDropdownMenuLink" href="/carrito-web">
                            Inicio<i class="fa fa-angle-down"></i>
                        </a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="/carrito-web/pages/todosProductos.jsp">Todos los
                            productos</a>
                    </li>
